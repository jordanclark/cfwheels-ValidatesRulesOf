...
<cfelseif NOT reFindNoCase( "^[A-Z0-9._%'+-]+@(?:[A-Z0-9-]+\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel)$", attributes.value )>
