...
<cfif NOT find( "@", arguments.value )>
	<cfset arguments.message = "is invalid without a ""@"" symbol, it should be like: ""Fed Flintston"" <fred@domain.com>">
<cfelseif NOT find( ".", arguments.value )>
	<cfset arguments.message = "is invalid without a period ""."", it should be like: ""Fed Flintston"" <fred@domain.com>">
...
<cfelseif NOT reFindNoCase( "^[""'](?:[A-Z0-9-]+ ){1,4}[""'] <[A-Z0-9._%'+-]+@(?:[A-Z0-9-]+\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel)>$", arguments.value )>
	...
	<cfset arguments.message = "is invalid, it should like: ""Fed Flintston"" <fred@domain.com>">
</cfif>
